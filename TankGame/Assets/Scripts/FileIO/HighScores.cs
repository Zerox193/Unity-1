...
public class HighScores : MonoBehaviour
{
    ...
    public void LoadScoresFromFile()
    {
        ...
        // seperatir between the directory and the filename!
        StreamReader fileReader = new StreamReader(currentDirectory + "\\" + scoreFileName);

        // A counter to make sure we don't go past the ebd of our scores
        int scoreCount = 0;
        ...
        while (fileReader.Peek() != 0 && scoreCount < scores.Length)
        {
            ...
            else
            {
                ...
                // junk in our file. Lets orunt an error, and then use a default value
    ...
    public void AddScore(int newScore)
    {
        ...
        if (desiredIndex < 0)
        {
            Debug.Log("scores of " + newScore + " not high enough for high score list.", this);
            return;
        }
        // Then we move all of the scores after that index
        // back by one position. We'll do thus by looping from
        ...
        Debug.Log("Score of " + newScore + " entered into high score at position " + desiredIndex, this);
    }
}
